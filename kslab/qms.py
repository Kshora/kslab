...
def qms_ig_calibration(raspi, qms, rangeis,gain = 1, show_summary = False, mass_select='2',style=False,xoffset=None,yoffset=None):
    ...
    try:
        ...
        raspi_calib = raspi.data.query(f"{a} < date < {b}").reset_index(drop=True)[['date','time','pd']]
...
def convert_itoj(i,k1=8.733935665396627,k2=69.68,c1=2.978590280897269e-07):
    from scipy.constants import Avogadro
    membrane_area = 0.02**2*np.pi
